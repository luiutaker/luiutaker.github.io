...
function append_text(txt) {
  ...
  function score_rb(form) {
    ...
    var text = document.createTextNode('Relax'); 
    var text2 = document.createTextNode('Be Happy');
...
function showModalInThePhone(){
  ...
  modalContent.innerHTML = `
    <div class="modal-content">
      ...
      <p>2、<b></b>如果觉得做得还行，看完剖析图和报告后可以捐点钱给我买游戏 :D</p>
...
function showModal() {
  ...
  modalContent.innerHTML = `
    <div class="modal-content">
      ...
      <p>1、我们不会收集任何与您有关的信息。为了避免测试白做，请一定要<b>先点击提交测试</b>按钮并查看您的结果！（建议截图）</p>
      ...
      <p>5、谢谢支持<b>，</b>如果觉得做得还行，看完剖析图和报告后可以捐点钱给我买游戏 :D</p>
      <p>6、Don't be afraid</p>
      <input class="my_button" type="button" value="我已认真阅读并知晓，可以开始测验" onclick="hideModal();">
    </div>
  `;
